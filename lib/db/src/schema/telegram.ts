...
export const telegramSettingsTable = pgTable("telegram_settings", {
  ...
  dailyPublicSummaryTime: text("daily_public_summary_time").notNull().default("23:30"),
  ...
  notifyDailyPublicSummary: boolean("notify_daily_public_summary").notNull().default(false),
